...
let oldIndex = null
let blockList = []
const threshold = header.clientHeight
const activeClass = 'nav__item_active'
const getThreshold = (element) => element.getBoundingClientRect().top - threshold - 10

linkList.forEach(item => blockList.push(document.querySelector(item.getAttribute('href'))))
